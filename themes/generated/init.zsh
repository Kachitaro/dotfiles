...
# --- fnm init ---
export PATH="C:\\Users\\JohnN\\AppData\\Local\\fnm_multishells\\14616_1787588844725":$PATH
export FNM_MULTISHELL_PATH="C:\\Users\\JohnN\\AppData\\Local\\fnm_multishells\\14616_1787588844725"
...
# --- carapace init ---
# export PATH="C:/Users/JohnN/.config/carapace/bin;$PATH"
...
compdef _carapace_completer "act" "adb" "age" "agg" "ansible" "ansible-config" "ansible-console" "ansible-creator" "ansible-doc" "ansible-galaxy" "ansible-inventory" "ansible-playbook" "ansible-pull" "ansible-vault" "ant" "apko" "apptainer" "apropos" "aqua" "ar" "argo" "argocd" "aria2c" "artisan" "asciinema" "atuin" "autoconf" "avdmanager" "aws" "az" "bat" "batdiff" "batgrep" "batman" "bazel" "bc" "benthos" "black" "bloop" "boundary" "brew" "brotli" "bru" "buildctl" "bun" "bunx" "but" "cal" "calibre" "capslock" "carapace" "cargo" "cargo-clippy" "cargo-fmt" "cargo-metadata" "cargo-rm" "cargo-set-version" "cargo-upgrade" "cargo-watch" "cdebug" "cekit" "charm" "chdman" "chezmoi" "chroma" "chromium" "circleci" "clamav-config" "clamav-milter" "clambc" "clamconf" "clamd" "clamdscan" "clamdtop" "clamonacc" "clamscan" "clamsubmit" "clion" "code" "code-insiders" "codecov" "colima" "compare" "composite" "conda" "conda-content-trust" "conda-env" "conky" "consul" "cosign" "crc" "crush" "csview" "cue" "cura" "curl" "d2" "dagger" "darktable" "darktable-cli" "dart" "datagrip" "dataspell" "dbt" "dc" "deadcode" "delta" "deno" "devbox" "devcontainer" "devpod" "dfc" "dict" "diff" "diff3" "dig" "direnv" "dive" "dlv" "dms" "dngconverter" "dnsmasq" "doas" "docker" "docker-buildx" "docker-compose" "docker-scan" "doctl" "doing" "dos2unix" "ebook-convert" "egrep" "electron" "elvish" "exa" "exercism" "eza" "faas-cli" "fastfetch" "fd" "ffmpeg" "ffplay" "ffprobe" "fgrep" "firefox" "flutter" "flyctl" "fnm" "freeze" "ftp" "ftpd" "fury" "fzf" "gatsby" "gcloud" "gdb" "gdown" "gdu" "get-env" "gh" "gh-copilot" "gh-dash" "gh-stack" "ghalint" "ghostty" "gimp" "git" "git-abort" "git-alias" "git-archive-file" "git-authors" "git-browse" "git-browse-ci" "git-clang-format" "git-clear" "git-clear-soft" "git-coauthor" "git-extras" "git-info" "git-standup" "git-unlock" "git-utimes" "gitk" "gitleaks" "gitlint" "gitsign" "gitui" "glab" "glow" "gm" "go" "go-carpet" "go-tool-asm" "go-tool-buildid" "go-tool-cgo" "go-tool-compile" "go-tool-covdata" "go-tool-cover" "go-tool-dist" "go-tool-doc" "go-tool-fix" "go-tool-link" "go-tool-mockgen" "go-tool-nm" "go-tool-objdump" "go-tool-pack" "gocyclo" "gofmt" "goimports" "goland" "golangci-lint" "gomplate" "gonew" "google-chrome" "gopls" "goreleaser" "goweight" "gpg" "gpg-agent" "gradle" "grep" "grype" "gsa" "gulp" "gum" "gunzip" "gzip" "hatch" "hcloud" "helix" "helm" "helmfile" "helmsman" "hexchat" "hexdump" "hostname" "htop" "http" "https" "hugo" "hurl" "hx" "hyperfine" "idea" "identify" "img2pdf" "incus" "inkscape" "inshellisense" "iredis" "jar" "java" "javac" "jj" "jq" "julia" "just" "k3sup" "k6" "k9s" "kak" "kak-lsp" "kcl" "keytool" "kitten" "kitty" "kmonad" "kompose" "kotlin" "kotlinc" "ktlint" "kubeadm" "kubebuilder" "kubectl" "kubeseal" "kustomize" "lazygit" "lefthook" "lf" "limactl" "litecli" "lnav" "lncrawl" "lua" "lzma" "magick" "make" "man" "marp" "maturin" "mcomix" "mdbook" "meld" "melt" "micro" "minikube" "mitmproxy" "mix" "mkcert" "mogrify" "molecule" "montage" "more" "mosh" "mousepad" "mpv" "mvn" "mycli" "n-m3u8dl-re" "nano" "nc" "ncdu" "neomutt" "nerdctl" "netcat" "newman" "newrelic" "nfpm" "ng" "nilaway" "nix" "nix-build" "nix-channel" "nix-instantiate" "nix-shell" "node" "nomad" "nox" "npm" "ntpd" "nu" "nvim" "oh-my-posh" "ollama" "op" "openscad" "openssl" "optipng" "orbctl" "packer" "palemoon" "pandoc" "pass" "pathchk" "patool" "pdfattach" "pdfdetach" "pdffonts" "pdfimages" "pdfinfo" "pdfseparate" "pdfsig" "pdftocairo" "pdftohtml" "pdftoppm" "pdftops" "pdftotext" "pdfunite" "pgcli" "php" "phpstorm" "picard" "pigz" "ping" "pip" "pipenv" "pipx" "pixi" "pkgsite" "pngcheck" "pnpm" "podman" "pprof" "present" "prettybat" "prettyping" "procs" "pscale" "pulumi" "pycharm" "pytest" "python" "qmk" "qpdf" "qrencode" "qutebrowser" "rails" "ramalama" "ranger" "rclone" "redis-cli" "restic" "resume-cli" "reuse" "rg" "rider" "rifle" "ripsecrets" "rsync" "rubymine" "rust-analyzer" "rustc" "rustdoc" "rustrover" "rustup" "saw" "scc" "scp" "script" "scriptlive" "scriptreplay" "sd" "sdkmanager" "semver" "serie" "set-env" "sftp" "slides" "slsa-verifier" "soft" "speedtest-cli" "sqlite3" "ssh" "ssh-agent" "ssh-copy-id" "ssh-keygen" "starship" "staticcheck" "strings" "supervisorctl" "supervisord" "svg-term" "svgcleaner" "syft" "talosctl" "taplo" "task" "tea" "telnet" "templ" "termux-apt-repo" "terraform" "terraform-ls" "terragrunt" "terramate" "tesseract" "tig" "tinygo" "tldr" "tmate" "tofu" "toit.lsp" "toit.pkg" "toolbox" "tor-browser" "tor-gencert" "tor-print-ed-signing-cert" "tor-resolve" "torsocks" "tox" "traefik" "transmission-cli" "transmission-create" "transmission-daemon" "transmission-edit" "transmission-remote" "transmission-show" "tree" "trivy" "ts" "tsc" "tsh" "tshark" "turbo" "typst" "unbrotli" "unlzma" "unpigz" "unset-env" "unxz" "unzip" "upower" "upx" "vagrant" "vault" "vercel" "vhs" "vi" "vim" "viu" "vivid" "vlc" "volta" "vunnel" "watch" "watchexec" "watchgnupg" "waypoint" "webstorm" "wezterm" "wget" "winget" "wire" "wireshark" "wishlist" "wt" "xh" "xonsh" "xxhsum" "xz" "xzcat" "yarn" "yj" "ykman" "youtube-dl" "yt-dlp" "zig" "zip" "zoxide"
